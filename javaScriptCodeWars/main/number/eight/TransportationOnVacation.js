 ...
 * off your total.
 *
 * Write a code that gives out the total amount for different days(daysAmount).
 */

function rentalCarCost(daysAmount) {
    return daysAmount < 3 ? daysAmount * 40 : daysAmount < 7 ? daysAmount * 40 - 20 : daysAmount * 40 - 50;
}
