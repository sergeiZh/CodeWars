/**
 * kata url - https://www.codewars.com/kata/prefill-an-array
 *
 * Description:
 ...
 * that is >=0, throw a TypeError. When throwing a TypeError, the message should be n is invalid,
...
function prefill(n, v) {
    if(n === Infinity || n === -Infinity || typeof n === 'boolean' || isNaN(n) || !Number.isInteger(Number(n)) ||  parseInt(n) < 0){
