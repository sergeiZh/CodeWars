/*
Kata ulr https://www.codewars.com/kata/5805ed25c2799821cb000005/train/javascript
Description:
...
function cake(x, y){
    let wordWeight = y.split('').reduce((prevValue, currValue, index) => {
        let charValue = y.charCodeAt(index);
        if((index + 1) %2 === 0){
            charValue = charValue - 96;
        }

        return prevValue + charValue;
    }, 0);

    return wordWeight/x > 0.7 ? 'Fire!' : 'That was close!';
}
